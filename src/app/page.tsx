          ...
          <div className="mx-4 md:mx-0 space-y-6 md:space-y-[80px] col-span-12 md:col-span-5">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="text-start mt-10 mb-40 md:mt-4 md:mb-0">
                <p className="text-gray-600 dark:text-gray-400 mb-4 font-medium text-[26px] md:text-base md:font-normal">membersmail@mail.xyz</p>
            ...
            <div className="text-left space-y-12 md:space-y-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg md:text-base text-justify md:text-left">
                Lorem ipsum dolor sit amet consectetur. Hac viverra parturient aliquet ut
                proin consectetur non nunc amet. Quis in in lacus ac sapien massa tellus massa.
                Dictum tellus diam viverra leo. Porta quis ultricies sed rhoncus.
              </p>
            </div>
          </div>
