  ...
  return (
    <section id={SECTION_IDS.OUR_TEAM} className="py-20 bg-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-center mb-4 tracking-wide">OUR DEDICATED TEAM</h2>
          <p className="text-center text-gray-700 mb-12 max-w-2xl mx-auto leading-relaxed">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Nullam aliquet, nisi sit amet ultrices tempor, odio <br /> magna tempus libero, in volutpat odio turpis sit amet <br /> urna. Integer a ex nec risus scelerisque dapibus. Nam <br /> cursus metus vel lorem varius, a laculis ligula sodales.
          </p>
        <Swiper
          modules={[Autoplay]}
          spaceBetween={5}
